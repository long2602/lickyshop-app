...
public class topAdapter extends RecyclerView.Adapter<topAdapter.shirtViewHolder>{
    ...
    public topAdapter(Context context, List<product> productList, List<image> imageList, RecyclerViewClickListener clickListener) {
    ...
    public class shirtViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public shirtViewHolder(@NonNull View itemView) {
            super(itemView);
            img=itemView.findViewById(R.id.items_product_imgView_item);
            name=itemView.findViewById(R.id.items_product_txtView_name);
            gia=itemView.findViewById(R.id.items_product_txtView_gia);
