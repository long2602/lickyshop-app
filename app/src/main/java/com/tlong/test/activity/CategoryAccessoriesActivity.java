...
import com.tlong.test.adapter.topAdapter;
...
public class CategoryAccessoriesActivity extends AppCompatActivity {
    ...
    private void EventClick() {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent RegisterPage=new Intent(CategoryAccessoriesActivity.this, MainActivity.class);
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent RegisterPage=new Intent(CategoryAccessoriesActivity.this, Cart2Activity.class);
                startActivity(RegisterPage);
            }
        });
        //mở trang tài khoản
...
//                    overridePendingTransition(R.anim.slide_from_right,R.anim.slide_to_left);
    ...
    private void getDuLieuSP() {
        ...
        String duongdan=Server.LinkProduct+"?page=4";
    ...
    private void AnhXa(){
        ...
        btnBack=(ImageButton)findViewById(R.id.accessories_imgBtn_back);
