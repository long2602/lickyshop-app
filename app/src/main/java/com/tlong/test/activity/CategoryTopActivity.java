...
public class CategoryTopActivity extends AppCompatActivity {
    ...
    private void EventClick() {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent RegisterPage=new Intent(CategoryTopActivity.this, MainActivity.class);
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent RegisterPage=new Intent(CategoryTopActivity.this, Cart2Activity.class);
                startActivity(RegisterPage);
            }
        });
    }
...
//                    overridePendingTransition(R.anim.slide_from_right,R.anim.slide_to_left);
    ...
    private void getDuLieuSP() {
        ...
        String duongdan=Server.LinkProduct+"?page=1";
    ...
    private void AnhXa(){
        ...
        btnBack=(ImageButton)findViewById(R.id.top_imgBtn_back);
